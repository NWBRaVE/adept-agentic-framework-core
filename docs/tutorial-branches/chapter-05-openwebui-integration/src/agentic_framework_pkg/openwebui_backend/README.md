...
Use the following command to build and start all the services. The agentic-framework openwebui_app module will serve as the backend to the openwebui front-end.
