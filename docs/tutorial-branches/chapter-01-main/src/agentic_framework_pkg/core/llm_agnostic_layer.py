...
class LLMAgnosticClient:
    ...
    def __init__(self):
        ...
        self._nvidia_base_url: str = os.getenv(NVIDIA_BASE_URL_ENV_VAR, "https://integrate.api.nvidia.com/v1")
        # The default vision model can be overridden by NVIDIA_MULTI_MODAL_MODEL_ENV_VAR
        self._nvidia_default_vision_model: str = os.getenv(NVIDIA_MULTI_MODAL_MODEL_ENV_VAR, DEFAULT_NVIDIA_VISION_MODEL)
        self._nvidia_async_client: Optional[openai.AsyncOpenAI] = None # Re-using openai.AsyncOpenAI for NVIDIA's compatible API
    ...
    async def _call_litellm(
        ...
        **kwargs: Any
        ...
        if azure_env_api_key and azure_env_api_base and azure_env_api_version:
            ...
            if final_api_key is None: final_api_key = azure_env_api_key
            if final_api_base is None: final_api_base = azure_env_api_base
            if final_api_version is None: final_api_version = azure_env_api_version
